...
def drug_drug_response_predict(smiles_pairs, task_list, device, batch_size):
...
if __name__ == '__main__':
    ...
    device = 'cuda:0'
    batch_size = 256
    print(drug_drug_response_predict(smiles_pairs, task_list, device, batch_size))
